...
يمتلك المتغيير `reset` أحد الخيارات المسماة `--hard`، واستخدام هذا الخيار قد يكون خطير للغاية كونه قد يتسبب في التراجع عن التعديلات التي قمت بها ليس فقط من **Staging Area** بل من **Repository**.
